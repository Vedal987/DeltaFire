...
public class WeaponSway : MonoBehaviour {
	...
	void  Update (){
		...
		float factorX = -Input.GetAxis("Mouse X") * amount + -Input.GetAxis("Horizontal") * amount / 4;
		float factorY = -Input.GetAxis("Mouse Y") * amount + Input.GetAxis("Vertical") * amount / 4;
